...
|_   __ \|_   _ \     |_   _|    Project for Better Journalism
  | |__) | | |_) |      | |      http://betterjournalism.org
  |  ___/  |  __'.  _   | |   
 _| |_    _| |__) || |__' |      This is STALLION, originally developed by Brandon Wang.
|_____|  |_______/ `.____.'   
...
<!-- Stallion -->
<link href="<?php bloginfo('stylesheet_directory'); ?>/resources/styling.css?stallion-3.2.6" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/resources/scripts.js?stallion-3.2.6"></script>
