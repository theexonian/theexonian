...
// register Metro_Magazine_Popular_Post widget
function metro_magazine_register_popular_post_widget() {
    register_widget( 'Metro_Magazine_Popular_Post' );
}
add_action( 'widgets_init', 'metro_magazine_register_popular_post_widget' );
 
 /**
 * Adds Metro_Magazine_Popular_Post widget.
 */
class Metro_Magazine_Popular_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'metro_magazine_popular_post', // Base ID
			esc_html__( 'RARA: Popular Post', 'metro-magazine' ), // Name
			array( 'description' => esc_html__( 'A Popular Post Widget', 'metro-magazine' ), ) // Args
		);
	}
...
} // class Metro_Magazine_Popular_Post 