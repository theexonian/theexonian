  ...
  $custom_settings = array(
    ...
    'settings'        => array(
      array(
        'id'          => 'logo_file',
        'label'       => 'Logo graphic',
        'desc'        => 'Logo graphics should be 100px in height (including breathing room on top and bottom), no more than 600px in width, and in a .png format with a transparent background. You should design your logo to work on dark backgrounds.',
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'site',
        'rows'        => '',
      ...
      array(
        'id'          => 'colorize_light',
        'label'       => 'Theme colors -- light',
        'desc'        => 'This color shows in the background of the footer, among other places. Please do not select black / a dark color here.',
        'std'         => '',
        'type'        => 'colorpicker',
        'section'     => 'site',
        'rows'        => '',
      ...
      array(
        'id'          => 'pbj_link',
        'label'       => '(Do not change) Banner link location',
      ...
      array(
        'id'          => 'pbj_disable_full',
        'label'       => '(Do not change) Disable all PBJ branding',
        'desc'        => 'The Project for Better Journalism includes various branding elements; PBJ chapters are required to display this branding. You should not disable this unless you know what you\'re doing.',
        'std'         => 'enable',
        'type'        => 'radio',
        'section'     => 'site',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => 'If Stallion is running in non-PBJ mode, the PBJ box is replaced with a Facebook "photomash". Designate the page name to use here (note: does not apply to PBJ chapters)',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'hp',
        'rows'        => '',
