...
<?php if (ot_get_option('pbj_disable_full','') != "disable") : ?>
				<div class="span3">
					<div class="pbj-block">
						...
						<p>The <a href="http://betterjournalism.org/">Project for Better Journalism</a> is a 501(c)(3) nonprofit organization dedicated to strengthening student journalism programs across the country. We provide and support publications just like this one.</p>
						<p><em><?php echo bloginfo("name"); ?></em> is a Project chapter's publication. Its content is created and updated by a team of students at this school, and supported by a faculty advisor.</p>
