<?php
/**
 * Credit: Make Theme by The Theme Foundry
 *
 * @package Reach
 */
...
if ( ! class_exists( 'Reach_Customizer_Misc_Control' ) ) :

/**
 * Class Reach_Customizer_Misc_Control
 *
 * Control for adding arbitrary HTML to a Customizer section.
 *
 * @since 1.0.0
 */
class Reach_Customizer_Misc_Control extends WP_Customize_Control {
    /**
    ...
    public function render_content() {
        switch ( $this->type ) {
            case 'group-title' :
                echo '<h4 class="reach-control-group-title">' . $this->label . '</h4>';
                if ( '' !== $this->description ) {
