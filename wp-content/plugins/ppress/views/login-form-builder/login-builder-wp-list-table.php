...
class Login_Builder_List_Table extends WP_List_Table {
	...
	function __construct() {
		...
		parent::__construct( array(
			'singular' => __( 'login', 'profilepress' ), //singular name of the listed records
			'plural'   => __( 'logins', 'profilepress' ), //plural name of the listed records
...
// Send final sort direction to usort
	...
	function column_title( $item ) {
		...
		$actions = array(
			'edit'   => sprintf( '<a href="?page=%s&action=%s&login=%s&_wpnonce=%s">Edit</a>', esc_attr( $_REQUEST['page'] ), 'edit', absint( $item['id'] ), $nonce_edit ),
