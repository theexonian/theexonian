...
Tags: login, registration, password reset, sidebar, members, profile, frontend, front-end, front-end profile, edit profile, avatar, custom login, custom registration, custom password reset, front-end profile, shortcode, ajax, registration, author, custom fields, file uploads, form builder, front-end login, front-end registration, log in, sidebar, sidebar login, wordpress login, facebook login, google, google login, linkedin, linkedin login, github, form, twitter, twitter login, gravatar, hide wp-admin, avatar upload, custom field registration, captcha, recaptcha, custom redirects, custom registration, custom registration form, ultimate member, profile, customize registration email, edit profile, email confirmation, extra user fields, front-end edit profile, front-end login, front-end register, front-end registration, front-end user registration, login redirect, login widget, password strength, multiple registration forms, password strength meter, profile builder, register form, registration, registration page, user approval, user custom fields, user email, user listing, user login, user profile, user registration, widget, tab, avatar, social login
...
### Free Extensions
* [Admin Bar & Dashboard Control](http://profilepress.net/downloads/admin-bar-dashboard-access-control/) - disable admin bar and control users access to WordPress admin / dashboard.
* [Navigation Menu Links](http://profilepress.net/downloads/email-confirmation/) - adding login, login/logout, registration, password reset, edit profile & my profile links to WordPress menu made easy.
...
* [WordPress & BuddyPress Extended Profile Sync](http://profilepress.net/downloads/wordpress-buddypress-extended-profile-sync/) - provides 2-way syncing of WordPress profile fields with BuddyPress extended profile.
* [Join BuddyPress Groups](http://profilepress.net/downloads/join-buddypress-groups/) - Allows users to select BuddyPress groups to join during registration.
* [Campaign Monitor](http://profilepress.net/downloads/campaignmonitor/) - automatically subscribe new users to your Campaign Monitor list.
...
*  Lots of bug fixes and code improments.
