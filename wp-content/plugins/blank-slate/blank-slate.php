...
/*
 * This is fork:
 * Original Author: Harri Bell-Thomas
 * Author URI: http://hbt.io/
 * Changed to give people a blank slate loading just header and footer
 * Use case: page builders
 */
...
class PageTemplater {
	...
	private function __construct() {
		...
		$this->templates = array(
			'blank-slate-template.php' => 'Blank Slate',
		);
