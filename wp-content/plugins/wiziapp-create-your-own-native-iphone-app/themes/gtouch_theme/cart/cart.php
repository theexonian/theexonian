...
<div class="shop_table cart">
		...
		if ( sizeof( $woocommerce->cart->get_cart() ) > 0 ) {
			foreach ( $woocommerce->cart->get_cart() as $cart_item_key => $values ) {
				...
				if ( $_product->exists() && $values['quantity'] > 0 ) {
					?>
					<div class = "<?php echo esc_attr( apply_filters('woocommerce_cart_table_item_class', 'cart_table_item', $values, $cart_item_key ) ); ?>">
						...
						<div class="product-name">
							<span class="wiziapp_woocommerce_cart_label"><?php _e( 'Product', 'woocommerce' ); ?></span>
							<?php
								if ( ! $_product->is_visible() || ( ! empty( $_product->variation_id ) && ! $_product->parent_is_visible() ) )
						...
						<div class="product-price">
							<span class="wiziapp_woocommerce_cart_label"><?php _e( 'Price', 'woocommerce' ); ?></span>
							<?php
						...
						<div class="product-quantity">
							<span class="wiziapp_woocommerce_cart_label"><?php _e( 'Quantity', 'woocommerce' ); ?></span>
							<?php
						...
						<div class="product-subtotal">
							<span class="wiziapp_woocommerce_cart_label"><?php _e( 'Total', 'woocommerce' ); ?></span>
							<?php
		...
		?>
			<div class="actions">
				...
				<input type="submit" class="button" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" /> <div class="wiziapp_woocommerce_cart_checkout"><input type="submit" class="checkout-button button alt" name="proceed" value="<?php _e( 'Proceed to Checkout &rarr;', 'woocommerce' ); ?>" /></div>
