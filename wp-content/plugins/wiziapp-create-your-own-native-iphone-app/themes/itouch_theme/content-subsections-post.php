		<div class="wiziapp_itouch_theme_cells_wrapper">
<?php
		$wiziapp_itouch_theme_categories = get_query_var('wiziapp_itouch_theme_categories');
		if ($wiziapp_itouch_theme_categories->haveTerms()&& wiziapp_theme_settings()->getPostDisplayCategories())
		{
?>
			<p class="wiziapp_itouch_theme_cell">
				<span><?php _e('Categories', 'wiziapp-smooth-touch'); ?></span>
<?php
			while ($wiziapp_itouch_theme_categories->haveTerms())
			{
				$wiziapp_itouch_theme_categories->theTerm();
?>
				<a href="<?php $wiziapp_itouch_theme_categories->theLink(); ?>" data-transition="slide">
					<?php $wiziapp_itouch_theme_categories->theName(); ?>
...
<?php
		...
		$wiziapp_itouch_theme_tags = get_query_var('wiziapp_itouch_theme_tags');
		if ($wiziapp_itouch_theme_tags->haveTerms())
		{
?>
			<p class="wiziapp_itouch_theme_cell">
				<span><?php _e('Tags', 'wiziapp-smooth-touch'); ?></span>
<?php
			while ($wiziapp_itouch_theme_tags->haveTerms())
			{
				$wiziapp_itouch_theme_tags->theTerm();
?>
				<a href="<?php $wiziapp_itouch_theme_tags->theLink(); ?>" data-transition="slide">
					<?php $wiziapp_itouch_theme_tags->theName(); ?>
...
if (wiziapp_theme_settings()->getPostDisplayComments())	{
	...
	$wiziapp_itouch_theme_comment_form = ob_get_clean();
	$wiziapp_itouch_theme_comment_form = str_replace(
		array('<input name="submit"', 'class="comment-respond"',),
		array('<input data-role="none" name="submit"', 'class="comment-respond wiziapp_itouch_theme_cells_wrapper"',),
		$wiziapp_itouch_theme_comment_form
	);
	echo $wiziapp_itouch_theme_comment_form;
}
?>
