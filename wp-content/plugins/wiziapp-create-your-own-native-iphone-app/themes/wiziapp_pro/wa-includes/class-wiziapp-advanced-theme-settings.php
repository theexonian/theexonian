<?php
	class WiziappAdvancedThemeSettings
	{
		var $autocommit = true;
		var $preview = false;
		var $dirty = false;
		...
		function deleteAll()
		{
			...
			{
				$this->option = 'wiziapp_plugin_wiziapp_advanced_theme_settings';
			}
	...
	function &wiziapp_advanced_theme_settings()
	{
		static $inst = null;
		if (!$inst)
		{
			$inst = new WiziappAdvancedThemeSettings();
		}
		return $inst;
	}
