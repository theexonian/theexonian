<?php
	class WiziappMagazineTouchThemeSettings
	{
		...
		function getAppPostListBackground()
		{
			return $this->options['app_post_list_background'];
		}

		function setAppPostListBackground($end_background)
		{
			$this->_load();
			$this->options['app_post_list_background'] = $end_background;
			$this->_save();
		}

		function getAppItemListBackground()
		{
			return $this->options['app_item_list_background'];
		}

		function setAppItemListBackground($end_background)
		{
			$this->_load();
			$this->options['app_item_list_background'] = $end_background;
			$this->_save();
		}
			...
			if (null === $this->options)
			{
				 ...
				 */
				 ...
				 array(
					 ...
					 'app_content_end_background' => '#ffffff',
					 'app_post_list_background' => '#cfe1e1',
					 'app_item_list_background' => '#282828',
				 );
			}
		}
