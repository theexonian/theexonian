<?php
	...
	if ($query->haveTerms())
	{
		while ($query->haveTerms())
		{
			$query->theTerm();
?>
	<li class="wiziapp-category" data-icon="arrow-r">
		<div class="wiziapp-category-post-count"><?php $query->theCount(__('No posts', 'wiziapp-smooth-touch'), __('1 post', 'wiziapp-smooth-touch'), __('% posts', 'wiziapp-smooth-touch')); ?></div>
