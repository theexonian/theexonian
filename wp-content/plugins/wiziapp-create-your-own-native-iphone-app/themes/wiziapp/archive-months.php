<?php
	$query = get_query_var('wiziapp_theme_archive_months');
	get_header();
...
?>
	<li class="wiziapp-archive" data-icon="arrow-r">
		<a href="<?php $query->theLink(); ?>" data-transition="slide" class="wiziapp-content-list-item">
			...
			<div class="wiziapp-archive-title"><?php $query->theMonth(); ?></div>
			<div class="wiziapp-archive-post-count">
				<?php $query->theCount(__('No posts', 'wiziapp-smooth-touch'), __('1 post', 'wiziapp-smooth-touch'), __('% posts', 'wiziapp-smooth-touch')); ?>
			</div>
		</a>
	</li>
<?php
