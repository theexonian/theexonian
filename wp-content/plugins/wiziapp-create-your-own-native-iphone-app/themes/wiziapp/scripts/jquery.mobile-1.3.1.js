...
(function( $, undefined ) {
		...
		$.mobile.path = path = {
			...
			isExternal: function( url ) {
				var u = path.parseUrl( url );
				return u.protocol && (u.domain && u.domain.toLowerCase()) !== (this.documentUrl.domain && this.documentUrl.domain.toLowerCase()) ? true : false;
			},
...
(function( $, undefined ) {
	...
	$.extend($.mobile.Navigator.prototype, {
		...
		go: function( url, data, noEvents ) {
			...
			if (window === window.top)	// Fix for Firefox: Changing the hash inside an iframe could cause an unwanted reload
...
(function( $, undefined ) {
	...
	$.mobile.loadPage = function( url, options ) {
		...
		if ( base && typeof settings.prefetch === "undefined" ) {
			base.reset();
		}
