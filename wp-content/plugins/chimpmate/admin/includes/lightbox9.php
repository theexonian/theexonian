...
.lite_tbox.mailicon:before{
background: {{getIcon('m6',15,data.theme.l9.lite_tbox_fc||'#000',345.779)}} no-repeat center;
}
.lite_tbox.pericon:before{
background: {{getIcon('m5',15,data.theme.l9.lite_tbox_fc||'#000',612)}} no-repeat center;
}
...
box-shadow: 0 0 1px 1px {{data.theme.l9.lite_check_borc||'#ccc'}};
}
#wpmchimpa .lite_check .ctext{
color: {{data.theme.l9.lite_check_fc||'#fff'}};
font-size: {{data.theme.l9.lite_check_fs}}px;
...
background-color: {{data.theme.l9.lite_check_c}};
}
...
content: {{data.theme.l9.lite_check_shade | chshade}};
margin: -4px;
display: block;
}
...
#wpmchimpa-main .sp8 {margin: 0 auto;width: 50px;height: 30px;}#wpmchimpa-main .sp8 > div {background-color: {{data.theme.l9.lite_spinner_c||'#000'}};margin-left: 3px;height: 100%;width: 6px;display: inline-block;-webkit-animation: wpmchimpa-mainsp8 1.2s infinite ease-in-out;animation: wpmchimpa-mainsp8 1.2s infinite ease-in-out;}#wpmchimpa-main .sp8 .sp82 {-webkit-animation-delay: -1.1s;animation-delay: -1.1s;}#wpmchimpa-main .sp8 .sp83 {-webkit-animation-delay: -1.0s;animation-delay: -1.0s;}#wpmchimpa-main .sp8 .sp84 {-webkit-animation-delay: -0.9s;animation-delay: -0.9s;}#wpmchimpa-main .sp8 .sp85 {-webkit-animation-delay: -0.8s;animation-delay: -0.8s;}@-webkit-keyframes wpmchimpa-mainsp8 {0%, 40%, 100% { -webkit-transform: scaleY(0.4) }  20% { -webkit-transform: scaleY(1.0) }}@keyframes wpmchimpa-mainsp8 {0%, 40%, 100% { transform: scaleY(0.4);-webkit-transform: scaleY(0.4);}  20% { transform: scaleY(1.0);-webkit-transform: scaleY(1.0);}}
